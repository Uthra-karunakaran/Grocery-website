...
export class LandingPageComponent {
  ...
  fruitsSelected = '';
  vegitablesSelected = '';
  fruitsVegetablesSelected = false;
dairyEggsSelected = false;
bakerySelected = false;
beveragesSelected = false;
snacksSelected = false;
  ...
  filterItems() {
    return this.data.filter(product => {
      ...
      const categoryMatch =
        ((!this.fruitsVegetablesSelected && !this.dairyEggsSelected && !this.bakerySelected && !this.beveragesSelected && !this.snacksSelected) ||
         (this.fruitsVegetablesSelected && product.category === 'Fruits & Vegetables') ||
         (this.dairyEggsSelected && product.category === 'Dairy & Eggs') ||
         (this.bakerySelected && product.category === 'Bakery') ||
         (this.beveragesSelected && product.category === 'Beverages') ||
         (this.snacksSelected && product.category === 'Snacks'));
